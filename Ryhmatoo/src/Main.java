...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) { //loob pealava
       ...
       //kolme punkti CSS
        ...
        tunnidA.setOnAction(e -> tekst1.setText("ƒrka ¸les kell " + lisaAeg((String) tunnidA.getValue() + ":" + (String)minutidA.getValue(),5,true)));
